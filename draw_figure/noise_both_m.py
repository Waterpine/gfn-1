...
def mean_generate():
    ...
    for cls in clss:
        ...
        for dataset in datasets:
            ...
            plt.savefig('../noise_both_mean/{}.pdf'.format(dataset),
                        bbox_inches="tight")
            plt.savefig('../noise_both_mean/{}.png'.format(dataset),
                        bbox_inches="tight")
            plt.close()
...
def mean():
    ...
    for cls in clss:
        ...
        for dataset in datasets:
            ...
            plt.xlabel('Noise Level', fontsize=16)
            plt.ylabel('Accuracy', fontsize=16)
            plt.savefig('../noise_both/{}.pdf'.format(dataset),
                        bbox_inches="tight")
            plt.savefig('../noise_both/{}.png'.format(dataset),
                        bbox_inches="tight")
            plt.close()
        ...
        for dataset in datasets:
            ...
            for model in models:
                ...
                while count < len(train_acc):
                    if dataset == datasets[int(count / 50)]:
                        data.append([randas[int(count / 10) % 5],
                                     train_acc[count],
                                     '{}(train)'.format(model)])
                    count = count + 1
                count = 0
            ...
            plt.xlabel('Noise Level', fontsize=16)
            plt.ylabel('Accuracy', fontsize=16)
            plt.savefig('../noise_both_last/{}.pdf'.format(dataset),
                        bbox_inches="tight")
            plt.savefig('../noise_both_last/{}.png'.format(dataset),
                        bbox_inches="tight")
            plt.close()
